...
parser = argparse.ArgumentParser(description='CS7GV1 Final Project');
...
parser.add_argument('--test', type=int, default=0,
                    help='set 0 for no test 1 for test')
...
if args.test == 1:
    ...
    testDataPath = '/home/stackoverflow/pytorch_demo/data/test/images/'
